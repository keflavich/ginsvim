...
if !exists("g:surround_no_mappings") || ! g:surround_no_mappings
  ...
  nmap      ySs  <Plug>YSsurround
  nmap      ySS  <Plug>YSsurround
  " NO MAP S!!!! if !hasmapto("<Plug>Vsurround","v") && !hasmapto("<Plug>VSurround","v")
  " NO MAP S!!!!   if exists(":xmap")
  " NO MAP S!!!!     xmap  s    <Plug>Vsurround
  " NO MAP S!!!!   else
  " NO MAP S!!!!     vmap  s    <Plug>Vsurround
  " NO MAP S!!!!   endif
  " NO MAP S!!!! endif
  " NO MAP S!!!! if !hasmapto("<Plug>VSurround","v")
  " NO MAP S!!!!   if exists(":xmap")
  " NO MAP S!!!!     xmap  S    <Plug>VSurround
  " NO MAP S!!!!   else
  " NO MAP S!!!!     vmap  S    <Plug>VSurround
